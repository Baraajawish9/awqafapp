...
urlpatterns = [
    ...
    path('students/assign-all-imported/', screen_views.assign_all_imported_students, name='assign_all_imported_students'),
    path('students/remove-all-imported/', screen_views.remove_all_imported_students, name='remove_all_imported_students'),
